...
```#yaml
EulerianCodeGen:
  - name: "STvAR: A Space-Time Variable Code Generator and Solver"
    summary: |
  ...
  - name: "Black Hole Mergers With Numerical General Relativity"
    summary: |
  ...
  - name: "Exploring Axions As Dark Matter Candidates"
    summary: |
...
LagrangianCodeGen:
  - name: "Code Generation for Particle-In-Cell Methods"
    summary: |
  ...
  - name: "Emu: An Open-Source PIC Solver For Six-Dimensional Neutrino Quantum Kinetics"
    summary: |
